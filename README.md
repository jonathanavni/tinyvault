...
| M8 — MCP stdio adapter | implemented on `codex/m8-mcp-adapter`; reviewed and gated at the round-3 cap; awaiting merge approval with recorded residuals; [locked packet](docs/m8-mcp-adapter-packet.md) |
