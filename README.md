...
| M8 — MCP stdio adapter | implemented on `codex/m8-mcp-adapter`; round-2 corrections entering gates and final round-3 review; [locked packet](docs/m8-mcp-adapter-packet.md) |
