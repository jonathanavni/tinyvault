...
| M8 — MCP stdio adapter | merged locally as `412b6687`; candidate reviews/gates complete at the round-3 cap with recorded residuals; push blocked by a red merged-tree M6 finalization test ([disposition](docs/m8-review-findings.md)); [locked packet](docs/m8-mcp-adapter-packet.md) |
