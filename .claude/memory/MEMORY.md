...
- [Gotchas — index](gotchas.md) — four topic files, consolidated 2026-09-09; the repeat offenders in one paragraph
  ...
  - [Verification, gates and mutants](gotchas_verif.md) — blind-spot lessons, owner-gate and commit-chain discipline, mutant hygiene, exact-SHA evidence carry, timeout-kill precision, measurement claims, owner real-route lessons (LP4: loop accompaniment, timing fields, own-state scan rule, isolated fixtures)
...
- [Conventions](conventions.md) — naming, structure, and workflow conventions established for this project, incl. the live-package close-out order
