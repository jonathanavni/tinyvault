...
> (`96e3ea3`) · **M5.1 ✅** · **M5.2 in flight** — spec LOCKED at revision 4 (`60520d9`), slices 1–2 of 6 merged
> (`ab52f8e`, `8133495`); **slice 3 next**, then M6 (`PLAN.md`). M4 and M5 carry deferred audit items — see their
