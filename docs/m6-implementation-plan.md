...
S4 is implemented and accepted at the round-3 cap (2026-09-07). S5 is implemented and accepted at the round-3 cap with the integrator confirmation pass (2026-09-08; register entry "S5 implementation — accepted", with declared residuals). S6 (E9/E10: clean clone, Docker, live cohorts, recording) remains due.
