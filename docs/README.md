...
- [`m9-onepassword-packet.md`](m9-onepassword-packet.md) — revision7 D1–D9/offline S1–S4 implemented and current offline gates pass (Entry65); M9 acceptance pending. Three implementation review rounds and all literal verdicts/limits, five historical paper rounds and Entry7 conditions retained. The separately approved M5 marker-wait repair is verified with full default gate and three scoped reviews passing (Entry70); historical failure causes remain unproven. V1, supported-OS qualification, clean-clone/integration and audit remain pending. [Per-user setup](onepassword-setup.md); decisions and exact evidence in the M9 register.
- [`m9-acceptance-approval.md`](m9-acceptance-approval.md) — Entry71/72 preparation: exact36-path commit/clean-clone proposal and bounded V1 card; neither executed. V1 executable observer/classifier and independent readiness evidence remain prerequisites; final manifest/patch hashes are external.
