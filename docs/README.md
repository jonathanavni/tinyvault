...
- [`m7-e8b-live-cohort-preregistration.md`](m7-e8b-live-cohort-preregistration.md) — E8b live cohort pre-registration, **rev 2 (2026-09-10, Sol fact-checked)**: attempt `E8b-A1-N10` on `bac91db`, cost derivation, the $10.00 **operational stop threshold approved by the user** with watcher/launcher hardening and local failure tests required before any start; no cohort has run.
