...
- [`m7-implementation-packet.md`](m7-implementation-packet.md) — the M7 implementation contract, **v4 accepted 2026-09-10** (two paper rounds; §11 user decisions D-2..D-6/O-3/O-M7-1; §12 dispositions); implemented on `codex/m7-fixtures`, candidate `9a826e5` awaiting final acceptance.
...
- [`m7-slice-spec.md`](m7-slice-spec.md) — M7 hostile fixtures #3–#4 slice spec, **rev 4 LOCKED** (amend-and-relock 2026-09-10 on D-2/D-3/D-6/O-3; round-2 corrections); implementation and live spend not authorized.
