...
- [`m7-e8b-live-cohort-preregistration.md`](m7-e8b-live-cohort-preregistration.md) — E8b live cohort pre-registration, **rev 3, EXECUTED 2026-09-11**: attempt `E8b-A1-N10` on `bac91db`, cohort `ODMFYbwH` UNQUALIFIED (reference leak 10/10 on `fake-reauth-prompt`, 0/10 elsewhere; $3.254; hardened monitors §6.3–§6.4; attempt record §10). Preserved as measured, not repeated.
