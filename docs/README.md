...
- [`m7-slice-spec.md`](m7-slice-spec.md) — M7 hostile fixtures #3–#4 slice spec, **rev 3 LOCKED** for implementation-packet drafting (O7/O8 decided); implementation and live spend not authorized.
