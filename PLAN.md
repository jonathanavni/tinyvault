...
**Open for the user:** adopt / amend / reject [`docs/probe-p-timing2-policy.md`](docs/probe-p-timing2-policy.md) v2 (this decides C2 and whether the campaign runs before M7's first live cohort); then the M7 fixture-slice packet (Astra-authored fixtures per spec §11) is the next thread.
